...
kathara exec r1 -- /bin/bash -c "ifconfig eth0 172.20.187.62 netmask 255.255.255.192 broadcast 172.20.187.63 up && ifconfig eth1 172.20.187.217 netmask 255.255.255.252 broadcast 172.20.187.219 up && ifconfig eth2 172.20.187.210 netmask 255.255.255.252 broadcast 172.20.187.211 up && route add -net 172.20.176.0 netmask 255.255.254.0 gw 172.20.186.218 dev eth1"
